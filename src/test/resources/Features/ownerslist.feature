Feature: En tant que visiteur du site web je peux afficher la liste de tous les proprietaires afin de trouver le proprietaire que je souhaite contacter
