Feature: Liste des vétérinaires
         En tant que visiteur du site web je peux avoir acces à la liste des vétérinaires afin de pouvoir consulter les informations de ceux-ci
