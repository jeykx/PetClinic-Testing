Feature: Informations d'un propriétaire
         En tant que visiteur du site web je peux rechercher un propriétaire par son nom afin d'avoir accés à ces informations
  ...
  Scenario: Le visiteur du site web accède à la fiche d’information d’un propriétaire
    ...
    Then j'accède à la fiche d'informations du propriètaire